{if count($products)>1}
	<div class="pos-new-product-home home-products col-xs-12 col-sm-8 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-2 col-md-offset-0 col-lg-offset-0">
		<div class="pos-new-product-home-title title">
			<h2>{l s='New products' mod='posnewproduct'}</h2>
		</div>
		<div class="row">
			<div class="home-product-control">
				<span class="home-product-prev pos-new-product-home-prev"></span>
				<span class="home-product-next pos-new-product-home-next"></span>
			</div>
			<ul id="pos-new-product-home" class="slider-row">			
	...
	<script>
		$(document).ready(function() {
			var pos1234 = $("#pos-new-product-home");
			pos1234.owlCarousel({
			autoPlay : false,
			items : 2,
				itemsDesktop : [1199,1],
				...
				$(".pos-new-product-home-next").click(function(){
					pos1234.trigger('owl.next');
				});
				$(".pos-new-product-home-prev").click(function(){
					pos1234.trigger('owl.prev');
				});
		});
	</script>
{/if}		 
