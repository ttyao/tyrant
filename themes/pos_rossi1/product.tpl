...
<div itemscope itemtype="http://schema.org/Product">
  <div class="primary_block row">
    ...
    <!-- end left infos-->
    <!-- center infos -->
    <div class="pb-center-column {if !$content_only} col-xs-12 col-sm-6 col-md-7{else}col-xs-12 col-sm-6 col-md-6{/if}">
      ...
      {if !$content_only}
            ...
            <ul id="usefull_link_block" class="clearfix no-print">
              ...
              <li class="print">
                <a href="javascript:print();" title="{l s='Print'}">{l s='Print'}</a>
              </li>
        ...
        <div class="box-info-product">
          ...
          <div class="countdown">
            {if $product->specificPrice && $product->specificPrice.reduction}
              ...
              <span id="future_date_{$product->id_category_default}_{$product->specificPrice.id_product}">
                      </span>
            {/if}
          </div>
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
  ...
  <ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
    ...
    {if $features}<li><a id="more_info_tab_data_sheet" href="#idTab2"><span>{l s='Data sheet'}</span></a></li>{/if}
    {if $attachments}<li><a id="more_info_tab_attachments" href="#idTab9"><span>{l s='Download'}</span></a></li>{/if}
    {if isset($accessories) AND $accessories}<li><a href="#idTab4"><span>{l s='Accessories'}</span></a></li>{/if}
    {if isset($product) && $product->customizable}<li><a href="#idTab10"><span>{l s='Product customization'}</span></a></li>{/if}
    <li><a href="#idTab5">{$HOOK_PRODUCT_TAB}</a></li>
  </ul>
