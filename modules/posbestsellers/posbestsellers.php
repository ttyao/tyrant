...
class posbestsellers extends Module
{
	...
	public function install()
	{
		...
		if (!parent::install()
			...
			|| !Configuration::updateValue('FEATURED_NBR',3)
			|| !Configuration::updateValue('PRODUCT_ITEM',1)
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitBestSellers'))
		{
			...
			Configuration::updateValue('FEATURED_NBR', (int)Tools::getValue('FEATURED_NBR'));
	...
	public function renderForm()
	{
		...
		$helper->tpl_vars = array(
			...
			'FEATURED_NBR' => Tools::getValue('FEATURED_NBR',Configuration::get('FEATURED_NBR')),
