...
class postabcateslider2 extends Module {
	private $spacer_size = '5';	
	private $_postErrors  = array();
	private $_html= null;
	public function __construct() {
		$this->name 		= 'postabcateslider2';
		$this->tab 			= 'front_office_features';
		$this->version 		= '1.5';
		$this->author 		= 'posthemes';
		$this->displayName 	= $this->l('Category Tabs Slider 2');
		$this->description 	= $this->l('Category Tabs Slider 2');
		parent :: __construct();
	...
	Configuration::updateGlobalValue($this->name . '_list_cate',$cateDefault);
      ...
      public function uninstall() {
        ...
        $this->_clearCache('postabcateslider2.tpl');
	...
	public function hookBlockPosition3($params) {
		...
		return $this->display(__FILE__, 'postabcateslider2.tpl');
	}
