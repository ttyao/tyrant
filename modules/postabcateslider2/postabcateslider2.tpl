		...
		<div class="container-inner row">
			<div class="tab-category">
				...
				<div class="tab_container"> 
					...
					<ul class="productTabCategorySlider productTabCategorySlider2">
					...
					var owl2 = $(".postabcateslider2 .productTabCategorySlider2");
					...
					$(".postabcateslider2 .productTabCategorySlider_next").click(function(){
					owl2.trigger('owl.next');
					})
					$(".postabcateslider2 .productTabCategorySlider_prev").click(function(){
