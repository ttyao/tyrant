<div class="col-xs-12 col-sm-6">
  ...
  <div class="payment_module box"{if $firstdata_ps_version < '1.5'} style="border: 1px solid #595A5E; padding: 0.6em; margin-left: 0.7em;"{/if}>
    <h3 class="stripe_title">
      {l s='Secure payment by credit card with FirstData' mod='firstdata'}
      <img alt="" src="{$module_dir}img/secure-icon.png" />
    </h3>
