				...
				<div class="tab_container"> 
					...
					<div class="item-inner">
						<div class="box-img">
							<div class="img_btn">
								<a 	class="quick-view" href="{$product.link|escape:'html':'UTF-8'}" 
									...
									title="{l s='Quick view' mod='postabcateslider4'}"></a>
								<a 	onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', $('#idCombination').val(), 1,'tabcategory'); return false;" 
									...
									title="{l s='Add to Wishlist' mod='postabcateslider4'}" ></a>
							</div>
							<div class="img_main">
						...
						{if isset($static_token)}
							<a class="cate_buy exclusive ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart',false, NULL, "add=1&amp;id_product={$product.id_product|intval}&amp;token={$static_token}", false)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Add to cart' mod='postabcateslider4'}" data-id-product="{$product.id_product|intval}">
								{l s='Add to cart' mod='postabcateslider4'}
							</a>
						{else}
							<a class="cate_buy exclusive ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart',false, NULL, 'add=1&amp;id_product={$product.id_product|intval}', false)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Add to cart' mod='postabcateslider4'}" data-id-product="{$product.id_product|intval}">
								{l s='Add to cart' mod='postabcateslider4'}
							</a>
						{/if}						
						{else}
