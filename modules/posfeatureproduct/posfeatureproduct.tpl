<div class="v-slider pos-feature-product col-xs-12 col-sm6 col-md-6 col-lg-4">
	<div class="v-slider-title">
		<h2>{l s='featured products' mod='posfeatureproduct'}</h2>
	</div>
	{if count($products)>1}
		<ul class="posfeatureproduct">			
	...
	{else}
	<p class="warning">{l s='No featured products at this time.' mod='posfeatureproduct'}</p>
	{/if}		 
</div>
