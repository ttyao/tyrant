...
{if $facebookcandvc_pshome == "pshome" && $facebookcandvcviscoupon_on == 1}
...
<div class="block products_block facebook-block" id="facebook-fan-coupon-block">
	...
	<div class="block_content">
       ...
       <fb:like share="false" href="{$facebookcandvcfanpageurl}" show_faces="{if $facebookcandvcshow_face==1}true{else}false{/if}"  width="{$facebookcandvcfwidth|escape:'html'}" height="{$facebookcandvcfheight|escape:'html'}" layout="{$facebookcandvclikelayout|escape:'html'}"></fb:like>
       </div>
