...
class ProductsCategory extends Module
{
  ...
  public function hookProductFooter($params)
  {
    ...
    if (!$this->isCached('productscategory.tpl', $this->getCacheId($cache_id)))
    {
      ...
      // Get infos
      // ($id_lang, $p, $n, $order_by = null, $order_way = null, $get_total = false, $active = true,
      //   $random = false, $random_number_products = 1, $check_access = true, Context $context = null)
      $category_products = $category->getProducts(
        ...
        $check_access = true,
        $context = null,
        $only_verified = true); /* 100 products max. */
