...
class TagCore extends ObjectModel
{
  ...
  */
  ...
  public static function getMainTags($id_lang, $nb = 10)
  {
    ...
    $results = [];
    $results[] = ['times' => 1, 'name' => '马油'];
    $results[] = ['times' => 1, 'name' => '美白'];
    $results[] = ['times' => 1, 'name' => '黄飞红'];
    $results[] = ['times' => 1, 'name' => '牛肉干'];
    $results[] = ['times' => 1, 'name' => '美白丸'];
    $results[] = ['times' => 1, 'name' => '面膜'];
    $results[] = ['times' => 1, 'name' => '酵素'];
    $results[] = ['times' => 1, 'name' => '美妆保养'];
    $results[] = ['times' => 1, 'name' => '减肥'];
    $results[] = ['times' => 1, 'name' => '方便面'];
    $results[] = ['times' => 1, 'name' => '爆鱼张'];
    $results[] = ['times' => 1, 'name' => '小肥羊'];
